...
public class Pipe extends Scrollable{
	...
	public void update(float delta) {
		...
		//be shifted by 1 pixel to the left (so that the skull is centered with respect
		//to its bar)
		...
		skullDown.set(position.x - (SKULL_WIDTH - width) / 2,
				barDown.y, SKULL_WIDTH, SKULL_HEIGHT);
	}
